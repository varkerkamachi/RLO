# OK, we have pretty much written one behavior quite a few times over and over again. 
# And that is the behavior of asking the user of our program for input, after prompting them.
# 
